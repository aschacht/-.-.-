...
public class GenerateAST {
	...
	public static void main(String[] args) throws IOException {
		...
		defineAST(outputDir, "Expr", Arrays.asList(
				...
				"Cup		:Token identifier , List<Stmt> declaration , String lexeme, Token reifitnedi , Token typeToEnforce , Expr prototype , Integer amount , boolean enforce",
				...
				"Knot		:Token identifier , List<Stmt> cupsAndPocketsGrouped , List<Stmt> unGrouped , String lexeme , Token reifitnedi ",
